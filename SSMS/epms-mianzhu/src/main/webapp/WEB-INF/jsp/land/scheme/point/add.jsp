...
<div class="row">
    <form id="inputForm" class="form-horizontal" action="${root}/land/sampling/scheme/point/doAdd/${menuid }/" method="post"
          style="margin-bottom:0;padding:0;">
        <input type="hidden" name="schemeId" value="${schemeInfo.id }" />
                ...
                <td style="width: 430px;padding-left:20px;position: relative">
                    ...
                    <div class="profile-user-info profile-user-info-striped width-100">
                        ...
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                <input type="text" id="areaCode" name="areaCode" maxlength="20"
                                       style="min-width:120px; width: 200px;" class="input-large required"/>
                                <span style="color: red">*</span>
                            </div>
                        </div>
                        ...
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                长：
                                <input type="text" id="rangeX" name="rangeX" maxlength="20"
                                       style="min-width:80px; width: 200px;" class="input-large number required"/>（米）
                                宽：
                                <input type="text" id="rangeY" name="rangeY" maxlength="20"
                                       style="min-width:80px; width: 200px;" class="input-large number required"/>（米）
                                <span style="color: red">*</span>
                            </div>
                        </div>
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                ...
                                <input type="hidden" id="isSamplingPoint" name="isSamplingPoint" />
                            </div>
                        </div>
