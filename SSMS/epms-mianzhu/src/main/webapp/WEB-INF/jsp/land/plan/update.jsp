    ...
    <form id="inputForm" class="form-horizontal" action="${root}/land/sampling/plan/doUpdate/${menuid }/" method="post"
        ...
        <div class="profile-user-info profile-user-info-striped">
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
					<c:forEach items="${samplingTypes }" var="item">
						<input type="checkbox" name="ckb_sampleCodes" value="${item.code }" ${disableMap[item.code] ? 'disabled=\"disabled\"' : '' } ${checkedMap[item.code] ? 'checked' : '' } />${item.name }&nbsp;&nbsp;
					</c:forEach>
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
					<input id="startTime" name="startTime" type="text" value="<fmt:formatDate value='${info.startTime }' pattern='yyyy-MM-dd'/>"
