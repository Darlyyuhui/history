...
<div class="row">
	<form id="inputForm" class="form-horizontal width-100 clearfix"
		action="${root}/land/block/doAdd/${menuid }/" method="post" style="margin-bottom:0;padding:0;">
                ...
                <td style="width: 430px;padding-left:20px;position: relative" class="td_h">
                    <div class="profile-user-info-striped width-100 pull-right" style="border:none;position: absolute;top:0">
                        ...
                        <div class="profile-info-row">
                            ...
                            style="width: 280px;"
                            class="input-large required" /> <span style="color:red">*</span> <span
                            id="checkCodeSpan" style="color: red"></span>
                        </div>
                    </div>
                    <div class="profile-info-row">
                    ...
                    <div class="profile-info-row">
                        ...
                        <div class="profile-info-value">
                        <select id="typeCode" name="typeCode" class="required"
                        style="width: 280px;">
                    ...
                    <div class="profile-info-row">
                        ...
                        style="min-width:120px; width: 280px;" class="input-large number" />
                        </div>
                    </div>
                    <div class="profile-info-row">
                    ...
                    <div class="profile-info-row">
                        ...
                        style="min-width:120px; width: 280px;" class="input-large" /> <input
                    ...
                    <div class="profile-info-row">
                        ...
                        <div class="profile-info-value">
                        <select id="polluteType" name="polluteType" style="width: 280px;">
                    ...
                    <div class="profile-info-row">
                        ...
                        <div class="profile-info-value">
                        <select id="ownerId" name="ownerId" style="min-width:120px; width: 280px;">
                    ...
                    <div class="clearfix form-actions width-100 pull-right" style="margin-top:0;background:none;padding: 0;bottom: 0">
