...
<div class="row">
    <form id="inputForm" class="form-horizontal" action="${root}/land/block/error/doAdd/${menuid }/" method="post"
          style="margin-bottom:0;padding:0;" enctype="multipart/form-data">
          <input type="hidden" name="landBlockId" value="${blockId }" />
        <div class="profile-user-info profile-user-info-striped">
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                	<input id="errorTime" name="errorTime" type="text" 
        ...
        <div class="profile-user-info profile-user-info-striped" style="border-top-style: none;">
           	<div class="profile-info-name" style="width: 110px;">异常描述</div>
			<div class="profile-info-value">
               	<textarea rows="5" style="min-width: 110px;width: 910px;" id="describe" name="describe"
               	  onkeyup="countChars(this, 'textDescribe')"></textarea> 
               	<br/>
