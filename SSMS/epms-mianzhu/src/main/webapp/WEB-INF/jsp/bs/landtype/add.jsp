...
<div class="row">
    <form id="inputForm" class="form-horizontal" action="${root}/bs/landtype/doAdd/${menuid }/" method="post"
        ...
        <div class="clearfix form-actions">
            <div class="col-md-offset-2 col-md-10">
                ...
                <button class="btn" type="reset" onclick="window.location.href='${root}/bs/landtype/list/${menuid }/'">
    ...
    function checkCode() {
    	...
    	if (codeObj.val() != "") {
    		$.ajax({
    			async:false,
    			type:"post",
    			url:"${root}/bs/landtype/checkCode/"+codeObj.val()+"/",
    			data:"tName=T_LAND_TYPE&cName=CODE",
