...
<div style="margin:10px 0">
    <form class="form-search" id="search-form" action="${root}/bs/standardIndustry/list/${menuid}/" method="post">
        <div class="row">
            <div class="col-xs-12 col-sm-8">
                <div class="input-group">
                    <input type="text" class="form-control search-query"  value="${standardIndustry.name}"
                           id="lampb_search_name" name="search_name" placeholder="标准名称"/>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body no-padding">
                    <form class="form-horizontal" id="advanForm" role="form" class="form-search"
                          action="${root}/bs/standardIndustry/list/${menuid}/" method="post">
                        ...
                        <div class="form-group" style="margin-top:10px;">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="van-search-code" name="search_code" value="${standardIndustry.code}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="van-search-name" name="search_name"
                                       value="${ standardIndustry.name}"
                                       placeholder="标准名称" style="width:300px" class="input-large"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right"
                                   for="van-search-sample">
                                样品
                            </label>

                            <div class="col-sm-9">
                                <input type="text" id="van-search-sample" name="search_sample"
                                       value="${ standardIndustry.sample}"
                                       placeholder="样品" style="width:300px" class="input-large"/>
                            </div>
                        </div>
                        <%-- <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right"
...
<script type="text/javascript">
    ...
    function showMaps() {
        window.location.href = "${root}/bs/standardIndustry/showMap/${menuid}/";
    }
 
    function showLocation() {
        window.location.href = "${root}/bs/standardIndustry/showLocation/?menuid=${menuid}";
    }

    function add() {
    	window.location.href = "${root}/bs/standardIndustry/add/${menuid}/?page=${page}";
    }
    function addBtn() {
    	window.location.href = "${root}/bs/standardIndustry/add/${menuid}/?page=${page}";
    }
    function updateById(id) {
        window.location.href = "${root}/bs/standardIndustry/update/${menuid}/" + id + "/?page=${page}";
    }

    function showViewById(id) {
        window.location.href = "${root}/bs/standardIndustry/showView/${menuid}/" + id + "/?page=${page}";
    }
    ...
    function deleteById(ids) {
        bootbox.confirm("删除后数据将无法恢复，确定要删除吗？",function(a) {
            if (!a) return;
            var url = "${root}/bs/standardIndustry/delete/" + ids + "/";
            $.ajax({
                type : 'post',
                url : url,
                dataType : "json",
    ...
    function goList() {
        window.location.href = "${root}/bs/standardIndustry/list/${menuid}/?page=${page}&isgetsession=1";
    }
