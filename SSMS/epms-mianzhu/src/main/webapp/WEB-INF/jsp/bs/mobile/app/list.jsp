                ...
                <tr>
                    ...
                    <td>
                        <div class="hidden-sm hidden-xs btn-group">
                            <button class="btn btn-xs btn-success" onclick="download('${item.name }','${item.saveUrl}')" title="下载APP">
...
<script type="text/javascript">
    ...
    function add() {
        window.location.href = "${root}/bs/mobile/app/add/${menuid}/?page=${page}";
    }
    ...
    function deleteById(ids) {
        bootbox.confirm("删除后数据将无法恢复，确定要删除吗？",function(a) {
            if (!a) return;
            var url = "${root}/bs/mobile/app/doDelete/";
            $.ajax({
                type: 'post',
                url: url,
                data : "ids="+ids,
    ...
    function goList() {
        window.location.href = "${root}/bs/mobile/app/list/${menuid}/?isgetsession=1";
    }
    function download(name,url) {
    	window.location.href = "${root}/downloadfile/"+name+".apk/?filepath="+url;
    }
</script>
