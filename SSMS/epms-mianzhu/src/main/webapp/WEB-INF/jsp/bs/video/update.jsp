...
<div class="row">
    <form id="inputForm" class="form-horizontal" action="${root}/bs/video/doUpdate/${menuid }/" method="post"
                ...
                <td style="width: 390px;padding-left:20px;position: relative">
                    <div style="border:none;position: absolute;top:0">
                        ...
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                <input type="text" id="inCode" name="inCode" maxlength="20" value="${info.inCode }"
                                       style="min-width:120px; width: 200px;" class="input-large required"/>
                                <span style="color: red">*</span>
                            </div>
                        </div>
                        ...
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                <input type="text" id="ip" name="ip" maxlength="15" value="${info.ip }"
                                       style="min-width:120px; width: 200px;" class="input-large"/>
                            </div></div>
                        <div class="profile-info-row">
                            <div class="profile-info-name">端口</div>
                            <div class="profile-info-value">
                                <input type="text" id="port" name="port" maxlength="6" value="${info.port }"
                        ...
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                <input type="text" id="user" name="user" maxlength="20" value="${info.user }"
                                       style="min-width:120px; width: 200px;" class="input-large"/>
                            </div>
                        </div>
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                <input type="password" id="pwd" name="pwd" maxlength="20" value="${info.pwd }"
                                       style="min-width:120px; width: 200px;" class="input-large"/>
                            </div>
                        </div>
                    </div>
