...
<div class="row">
    <form id="inputForm" class="form-horizontal" action="${root}/analysis/land/doUpdate/${menuid }/" method="post"
        ...
        <div class="profile-user-info profile-user-info-striped">
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
					<input type="radio" name="rdo_isOver" value="1" onclick="isOverLock()" ${info.isOver eq '1' ? 'checked' : '' } />是
					<input type="radio" name="rdo_isOver" value="0" onclick="isOverLock()" ${info.isOver eq '0' ? 'checked' : '' } style="margin-left: 10px;"/>否
					<input type="hidden" id="isOver" name="isOver" value="${info.isOver }" />
				</div>
				
				<div class="profile-info-name">超标项</div>
                <div class="profile-info-value">
					<input type="text" id="overItem" name="overItem" maxlength="20" readonly="readonly" value="${info.overItem }"
						style="min-width:120px; width: 350px;" class="input-large"/>
				</div>
            </div>
