...
<div class="row">
    <form id="inputForm" class="form-horizontal" action="${root}/repair/capital/doUpdate/${menuid }/" method="post"
        ...
        <div class="profile-user-info profile-user-info-striped">
            ...
            <div class="profile-info-row">
				...
				<div class="profile-info-name" style="width: 100px;">资金来源</div>
                <div class="profile-info-value">
                	<select id="source" name="source" style="min-width:120px; width: 350px;" class="required">
                		<tags:diccache typeCode="LAND_CAPITAL_SOURCE" defaultValue="${info.source }" />
                	</select>
					<span style="color: red">*</span>
				</div>
            </div>
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
					<input id="moneyTime" name="moneyTime" type="text" value="<fmt:formatDate value='${info.moneyTime }' pattern='yyyy-MM-dd hh:mm:ss'/>"
                ...
                <div class="profile-info-value">
					<input type="text" id="total" name="total" maxlength="10" value="${info.total }"
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
					<input type="text" id="competentUnit" name="competentUnit" maxlength="30" value="${info.competentUnit }"
						style="min-width:120px; width: 350px;" class="input-large" />
				</div>
				
				<div class="profile-info-name">使用状态</div>
                <div class="profile-info-value">
					<input type="radio" name="rdo_useStatus" value="1" ${info.useStatus eq '1' ? 'checked' : '' } />已使用
					<input type="radio" name="rdo_useStatus" value="0" ${info.useStatus eq '0' ? 'checked' : '' } style="margin-left: 10px;" />未使用
