...
<form id="inputForm" class="form-horizontal" action="${root}/repair/process/doUpdate/${menuid}/" method="post"
        ...
        <div class="profile-user-info profile-user-info-striped">
        	<div class="profile-info-row">
                ...
                <div class="profile-info-value">
                	<input type="text" id="stageName" name="stageName" readonly="readonly" value='<tags:xiangxuncache keyName="REPAIRSTAGE_IDNAME" id="${info.stageId }"/>'
                       class="input-large required input-width" />
                   	<input type="hidden" id="stageId" name="stageId" value="${info.stageId }"/>
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                	<input id="workDate" name="workDate" type="text" value="${info.workDate }"
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                	<input type="text" id="workDept" name="workDept" maxlength="30" value="${info.workDept }"
                       class="input-large required input-width" />
                    <span style="color: red">*</span>
                </div>
            </div>
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                	<textarea rows="5" class="input-width" id="workContent" name="workContent"
                	  onkeyup="countChars(this, 'textworkContent')">${info.workContent }</textarea> 
                	<br/>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#workDept").focus();
        countChars(document.getElementById("workContent"), "textworkContent");
    });
    function checkForm() {
    	if (v.checkForm()) {
    		$("#inputForm").submit();
