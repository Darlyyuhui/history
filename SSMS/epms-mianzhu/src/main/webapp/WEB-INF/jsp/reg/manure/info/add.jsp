...
<div class="row">
    <form id="inputForm" class="form-horizontal" action="${root}/reg/manure/doAdd/${menuid }/" method="post"
                ...
                <td style="width: 430px;padding-left:20px;">
                    <div style="border:none;min-height:720px">
                        ...
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                <input type="text" id="shopName" name="shopName" maxlength="20"
                                       style="min-width:120px; width: 180px;" class="input-large required"/>
                                <span style="color: red">*</span>
                            </div>
                        </div>
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                <input type="text" id="shopkeeper" name="shopkeeper" maxlength="20"
                        ...
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                <input type="text" id="dealManure" name="dealManure" maxlength="50"
                                       style="min-width:120px; width: 180px;" class="input-large" />
                            </div>
                        </div>
    ...
    function checkCode() {
    	...
    	if (codeObj.val() != "") {
    		$.ajax({
    			async:false,
    			type:"post",
    			url:"${root}/reg/manure/checkCode/"+codeObj.val()+"/",
    			data:"tName=T_SAMPLING_MANURE_REG&cName=CODE",
