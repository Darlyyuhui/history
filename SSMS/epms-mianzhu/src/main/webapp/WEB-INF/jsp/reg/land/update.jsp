                        ...
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                <input type="text" id="name" name="name" maxlength="50" value="${info.name }"
                                       style="min-width:120px; width: 180px;" class="input-large required left-map-input-width"/>
                                <span style="color: red">*</span>
                            </div>
                        </div>
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                <input type="text" id="depth" name="depth" maxlength="10" value="${info.depth }"
                                       style="min-width:120px; width: 180px;" class="input-large required number left-map-input-width"/>
                                <span style="color: red">*</span>
                            </div>
                        ...
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                <input type="text" id="longitude" name="longitude" maxlength="12" value="${info.longitude }"
                                       style="min-width:120px; width: 180px;" class="input-large number left-map-input-width"/>
                            </div>
                        </div>
                        <div class="profile-info-row">
                        ...
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                <select id="samplingType" name="samplingType" class="required left-map-input-width">
                                	<tags:diccache typeCode="SAMPLING_LAND_TYPE" defaultValue="${info.samplingType }" />
                                </select>
                                <span style="color: red">*</span>
                            </div>
                        </div>
                        ...
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                <input type="text" id="samplingUser" name="samplingUser" maxlength="20" value="${info.samplingUser }"
                                       style="min-width:120px; width: 180px;" class="input-large left-map-input-width"/>
                            </div>
                        </div>
                        <div class="profile-info-row">
