...
<div class="row">
    <form id="inputForm" class="form-horizontal" action="${root}/reg/water/pollute/doAdd/${menuid }/" method="post"
          style="margin-bottom:0;padding:0;" enctype="multipart/form-data">
          <input type="hidden" name="waterId" value="${waterInfo.id }" />
        <div class="profile-user-info profile-user-info-striped">
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                	<select id="typeCode" name="typeCode" style="min-width:120px; width: 350px;">
                		<tags:diccache typeCode="SAMPLING_WATER_POLLUTE_TYPE" />
                	</select>
				</div>
            </div>
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
					<input type="text" id="features" name="features" maxlength="50"
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
					<input type="text" id="scale" name="scale" maxlength="50"
						style="min-width:120px; width: 350px;" class="input-large"/>
				</div>
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
					<select id="status" name="status" style="min-width:120px; width: 350px;">
						<tags:diccache typeCode="SAMPLING_WATER_POLLUTE2" />
					</select>
				</div>
				
				<div class="profile-info-name">是否有明显排污口</div>
                <div class="profile-info-value">
					<input type="radio" name="rdo_isOutfall" value="1" checked/>是
					<input type="radio" name="rdo_isOutfall" value="0" style="margin-left: 10px;" />否
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
					<input type="text" id="riverDistance" name="riverDistance" maxlength="20"
