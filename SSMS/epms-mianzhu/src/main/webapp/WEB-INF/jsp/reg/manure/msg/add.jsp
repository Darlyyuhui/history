...
<div class="row">
    <form id="inputForm" class="form-horizontal" action="${root}/reg/manure/msg/doAdd/${menuid }/" method="post"
          style="margin-bottom:0;padding:0;" enctype="multipart/form-data">
          <input type="hidden" name="manureRegId" value="${manureReg.id }" />
        <div class="profile-user-info profile-user-info-striped">
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                	<select id="typeCode" name="typeCode" style="min-width:120px; width: 350px;" class="required">
                		<tags:diccache typeCode="SAMPLING_MANURE_TYPE" />
                	</select>
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
					<input type="text" id="sale" name="sale" maxlength="15"
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
					<input type="text" id="suggest" name="suggest" maxlength="15"
						style="min-width:120px; width: 350px;" class="input-large required number"/>
					<span style="color: red">*</span>
				</div>
            </div>
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
					<input type="text" id="salesYear" name="salesYear" maxlength="4"
