...
<div style="margin:10px 0">
    <form class="form-search" action="${root}/reg/air/list/${menuid}/" method="post">
        <div class="row">
            <div class="col-xs-12">
...
<div id="modal-table" class="modal fade" tabindex="-1" style="top:80px;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="advanForm" role="form" class="form-search" action="${root}/reg/air/list/${menuid}/" method="post">
...
<script type="text/javascript">
    function goList() {
        window.location.href = "${root}/reg/air/list/${menuid}/?isgetsession=1";
    }
    ...
    function add() {
        window.location.href = "${root}/reg/air/add/${menuid}/?page=${page}";
    }
    function updateById(id) {
        window.location.href = "${root}/reg/air/update/${menuid}/"+id+"/?page=${page}";
    }
    function showViewById(id) {
        window.location.href = "${root}/reg/air/showView/${menuid}/"+id+"/?page=${page}";
    }
    ...
    function checkByIds() {
        ...
        if (ids.length == 0) {
        	...
        	bootbox.confirm("确定要核查选中的数据吗？",function(a) {
                if (!a) return;
                var url = "${root}/reg/air/checkRegs/";
                $.ajax({
                    type: 'post',
                    url: url,
