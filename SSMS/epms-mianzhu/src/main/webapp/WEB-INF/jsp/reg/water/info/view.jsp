            ...
            <tr class="td_h">
                ...
                <td style="width: 430px;padding-left:20px;">
                    ...
                    <div class="profile-info-row">
                        ...
                        <div class="profile-info-value">
                            <tags:xiangxuncache keyName="Dic" typeCode="SAMPLING_WATER_TYPE2" id="${info.samplingType }"/>
                        </div></div>
                    <div class="profile-info-row">
                        <div class="profile-info-name">污染源状态</div>
                        <div class="profile-info-value">
                            <tags:xiangxuncache keyName="Dic" typeCode="SAMPLING_WATER_POLLUTE1" id="${info.polluteSs }"/>
                        </div>
                    </div>
