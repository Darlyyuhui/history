...
public class ApbInfo {
    ...
    private List<ApbProduct> produactList;
    ...
    public List<ApbProduct> getProduactList() {
		return produactList;
	}

	public void setProduactList(List<ApbProduct> produactList) {
		this.produactList = produactList;
	}
