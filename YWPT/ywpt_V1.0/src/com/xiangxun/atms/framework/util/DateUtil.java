...
public class DateUtil {
	...
	public static int getTimeDayInt() {
		int n = 0;
		java.util.Calendar ca = java.util.Calendar.getInstance();
		n = ca.get(java.util.Calendar.YEAR);
		n = n * 100;
		n = n + ca.get(java.util.Calendar.MONTH) + 1;
		n = n * 100;
		n = n + ca.get(java.util.Calendar.DAY_OF_MONTH);
		return n;
	}
	...
	public static long getTimeHourLong(java.util.Calendar ca) {
		long n = 0;
		n = ca.get(java.util.Calendar.YEAR);
		n = n * 100;
		n = n + ca.get(java.util.Calendar.MONTH) + 1;
		...
		n = n + ca.get(java.util.Calendar.DAY_OF_MONTH);
		n = n * 100;
		n = n + ca.get(java.util.Calendar.HOUR_OF_DAY);
		return n;
	}

	public static long getTimeMinuteLong(java.util.Calendar ca) {
		long n = 0;
		n = ca.get(java.util.Calendar.YEAR);
		n = n * 100;
		n = n + ca.get(java.util.Calendar.MONTH) + 1;
		...
		n = n + ca.get(java.util.Calendar.HOUR_OF_DAY);
		n = n * 100;
		n = n + ca.get(java.util.Calendar.MINUTE);
		return n;
	}

	public static long getTimeSecondLong(java.util.Calendar ca) {
		long n = 0;
		n = ca.get(java.util.Calendar.YEAR);
		n = n * 100;
		n = n + ca.get(java.util.Calendar.MONTH) + 1;
	...
	public static long getTimeMsLong(java.util.Calendar ca) {
		long n = 0;
		n = ca.get(java.util.Calendar.YEAR);
		n = n * 100;
		n = n + ca.get(java.util.Calendar.MONTH) + 1;
		...
		n = n + ca.get(java.util.Calendar.MINUTE);
		n = n * 1000;
		n = n + ca.get(java.util.Calendar.MILLISECOND);
		return n;
	}
	...
	public static int getHourInt() {
		java.util.Calendar ca = java.util.Calendar.getInstance();
		int n = ca.get(java.util.Calendar.HOUR_OF_DAY);
		return n;
	}
	 ...
	 * @throws ParseException
	 */
	public static java.util.Date parseDate(String s, String pattern) throws ParseException {
	 ...
	 * @throws ParseException
	 */
	public static java.util.Date parseUtilDate(String s, String pattern) throws ParseException {
		return new SimpleDateFormat(pattern).parse(s);
	}
	 ...
	 */
	public static java.util.Date sql2UtilDate(java.sql.Date date) {
		if (date == null) {
			return null;
		}
		else {
	 ...
	 */
	public static java.sql.Timestamp uitl2Timestamp(java.util.Date date) {
		if (date == null) {
			return null;
		}
		else {
	 ...
	 * @return java.util.Date - 转换后的java.util.Date
	 */
	public static java.util.Date timestamp2UtilDate(java.sql.Timestamp timestamp) {
		if (timestamp == null) {
			return null;
		}
		else {
	 ...
	 * @return
	 */
	public static List<String> getAllMonthsByMonth(String paramString1, String paramString2,String pattern) {
		ArrayList<String> localArrayList = new ArrayList<String>();
		try {
			Date localDate1 = parseDate(paramString1, pattern);
			Date localDate2 = parseDate(paramString2, pattern);
