...
import static com.xiangxun.atms.framework.constant.Constant.POST;
import static com.xiangxun.atms.framework.constant.Constant.UTF8;
...
public class RequestUtils {
	 ...
	 * @return
	 */
	public static String getLocationContextPath(HttpServletRequest request) {
	...
	public static String getRequestedSessionId(HttpServletRequest request) {
		...
		if (request.isRequestedSessionIdFromURL() || StringUtils.isBlank(ctx)) {
			...
			// 手动从cookie获取
			Cookie cookie = CookieUtil.getCookie(request,Constant.JSESSION_COOKIE);
			if (cookie != null) {
