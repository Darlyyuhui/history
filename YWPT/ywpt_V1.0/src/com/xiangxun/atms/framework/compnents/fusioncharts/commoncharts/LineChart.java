...
/**
 * <p>
 * Description: 这个类是处理:所有类型的线型图（单线图、多线图、滚动线图）
 */
...
public class LineChart extends BaseChart {
	...
	private String caption,subCaption, xAxisName, yAxisName, showValues = "0",
			numberPrefix, rotateYAxisName = "1", yAxisNameWidth = "15",
			numVisiblePlot = "0",numberSuffix,yAxisMinValue,yAxisMaxValue;
	...
	// 单线图
	public String RenderSingleLineChart(List<? extends ChartDataVo> datalist) {
	...
	// 滚动单线图
	public String RenderScrollSingleLineChart(
	...
	// 多线图
	public String RenderMultiLineChart(List<? extends ChartDataVo> datalist) {
		Categories categories = new Categories();
		List<Category> listcategory = new ArrayList<Category>();
		for (ChartDataVo vo : datalist) {
