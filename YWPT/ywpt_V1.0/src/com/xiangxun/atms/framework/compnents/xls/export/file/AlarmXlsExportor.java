 ...
 * @author yantao
 */
public class AlarmXlsExportor extends AbstractXLSExprotor{
	
	private static Logging logger = new Logging(AlarmXlsExportor.class);
...
//					cell.setCellValue(text);
	...
	public static void main(String[] args) {
		...
		AlarmXlsExportor export = new AlarmXlsExportor();
