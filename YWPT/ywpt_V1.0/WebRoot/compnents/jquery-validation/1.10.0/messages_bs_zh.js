...
$.validator.addMethod("characterfilter", function (value, element, param) {
	var d = /^[A-Za-z0-9-]+$/;
	return d.test(value);
},"\u53EA\u80FD\u8F93\u5165\u82F1\u6587\u3001\u6570\u5B57\u548C\u8FDE\u63A5\u7B26");
...
$.validator.addMethod(
    ...
    {
    	if(value != ''){
    		if (value.indexOf(".pdf")>0||value.indexOf(".PDF")>0||value.indexOf(".doc")>0||value.indexOf(".DOC")>0||
    				value.indexOf(".docx")>0||value.indexOf(".DOCX")>0||value.indexOf(".xls")>0||value.indexOf(".XLS")>0||
    				value.indexOf(".xlsx")>0||value.indexOf(".XLSX")>0||value.indexOf(".ppt")>0||value.indexOf(".PPT")>0||
    				value.indexOf(".pptx")>0||value.indexOf(".PPTX")>0||value.indexOf(".txt")>0) return true;
    		return false;
    	}else{
    		return true;
    	}
...
$.validator.addMethod("minCompare", function (value, element) {
 ...
 //IP模糊输入效验  YANTAO ADD 2014.11.06
 $.validator.addMethod("xinghaoDigits", function (value, element, param) {
    var t = /^(\d{1,2}|1\d\d|2[0-4]\d|25[0-5]|\**\d{0,2}|\**|\d{0,2}\**|\*\d\*|\d\*\d)$/
	var d = /^[*0-9]+$/;
