...
(function (a) {
	...
	}, minTo:function (b, c, d) {
		var e = a(d);
		return this.settings.onfocusout && e.unbind(".validate-minTo").bind("blur.validate-minTo", function () {
			a(c).valid();
		}),Number(b) < Number(e.val());
	}, maxTo:function (b, c, d) {
		var e = a(d);
		return this.settings.onfocusout && e.unbind(".validate-maxTo").bind("blur.validate-maxTo", function () {
			a(c).valid();
		}),Number(b) > Number(e.val());
