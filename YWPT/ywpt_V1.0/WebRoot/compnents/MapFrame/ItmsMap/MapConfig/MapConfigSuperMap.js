MapFactory.Define("ItmsMap/MapConfig",[
	...
	var serviceUrl = supermapbaseurl+"/services/",//"http://193.169.100.111:8090/iserver/services/"
	...
	var layers = {
		baseMap : {name:"底图",url:serviceUrl+"map-tianditu/rest/maps/矢量底图_经纬度",id:"baseMap",allowOperation:false},
		//baseMap : {name:"底图",url:serviceUrl+"map-tianditu4/rest/maps/矢量中文注记_经纬度",id:"baseMap",allowOperation:false},
		baseMapLabels : {name:"中文标记",url:serviceUrl+"map-tianditu/rest/maps/矢量中文注记_经纬度",id:"baseMapLabels"},
		//baseMapLabels : {name:"中文标记",url:serviceUrl+"map-tianditu4/rest/maps/矢量底图_经纬度",id:"baseMapLabels"},
		//baseMap : {name:"底图",url:serviceUrl+"map-dmms-roadline/rest/maps/roadline@dmms-roadline",id:"baseMap",allowOperation:false},
