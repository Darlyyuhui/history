MapFactory.Define("MapFactory/GraphicManager",[
	...
	return function(id,conf){
		...
		function highlight(){
			...
			highlightGraphic = new SuperMap.Feature.Vector(_geoUtil.convertFromMapFactory(_geoUtil.convertFromObject(geo)),{},_symbolUtil.convertFromMapFactory(geoType,highlightSym));
