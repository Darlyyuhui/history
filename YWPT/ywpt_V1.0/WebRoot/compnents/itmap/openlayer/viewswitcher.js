 ...
 * @since 2014-02-19
 */
itmap.openlayer.viewSwitcher = function(params){
...
itmap.openlayer.viewSwitcher.prototype = {
	...
	_init : function(){
		...
		this._currentExtent = this._map.getExtent();
	},
	...
	_bindMapEventListener : function(){
		...
		_map.events.register("movestart",_map,function(event){
			_instance._recordFlag = _map.dragging;
		});
		
		_map.events.register("moveend",_map,function(event){
			if(_instance._recordFlag){
				_instance._extentRecord(_map.getExtent());
