...
itmap.util.dialog = (function() {
	return function(conf) {
		...
		function setTitle(titleString){
			...
			DialogBoxTitle.children[0].innerHTML = titleString;
			return api;
		}
		...
		function setContent(content){
			...
			if(DialogBoxContent.clientHeight > _conf.maxHeight){
				...
				DialogBoxContent.style.overflowY = "auto";
			}
			DialogOuterBox.style.width = "";
			DialogOuterBox.style.width = DialogBoxContent.offsetWidth + 20 + "px";
			_setDialogPosition();
			return api;
		}
