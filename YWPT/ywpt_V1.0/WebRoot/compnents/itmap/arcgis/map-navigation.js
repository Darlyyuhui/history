...
var itmap = itmap ? itmap : {"arcgis":{}};
itmap.arcgis.navigation = function(o){
...
itmap.arcgis.navigation.prototype = {
	...
	_bindButton : function(){
		...
		var _bindEvents = {
			panTop : (function(){return function(){conf.mapC.panUp()}})(),
			panRight : (function(){return function(){conf.mapC.panRight()}})(),
			panBottom : (function(){return function(){conf.mapC.panDown()}})(),
			panLeft : (function(){return function(){conf.mapC.panLeft()}})(),
			fullExtent : (function(){return function(){conf.mapC.setExtent(conf.initExtent)}})()
		};
