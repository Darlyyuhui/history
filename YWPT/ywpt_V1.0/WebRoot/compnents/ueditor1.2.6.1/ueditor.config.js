...
(function () {
     ...
     */
	  var root = "/ywpt";
	  window.UEDITOR_HOME_URL=root+"/compnents/ueditor1.2.6.1/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:root+"/imageup"             //图片上传提交地址
        ,imagePath: "/ywpt/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        ,catcherUrl:root+"/lsremoteImage"   //处理远程图片抓取的地址
        ...
        ,snapscreenServerUrl: URL +"imageup" //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/jsp/snapImgUp.jsp"”
        ,snapscreenPath: URL + "upload"
        ,snapscreenServerPort: location.port                                   //屏幕截图的server端端口
        //,snapscreenImgAlign: ''                                //截图的图片默认的排版方式

        //word转存配置区
        ,wordImageUrl:root+"/imageup"             //word转存提交地址
