...
function flush(){
	$.ajax({
		...
		success:function(returnedData){
			...
			str0 += "<td style='max-width:50px;white-space:nowrap;overflow:hidden;text-overflow: ellipsis;' title='"+jo0.user_name+"("+jo0.user_id+")'>"+jo0.user_name+"("+jo0.user_id+")</td>";
