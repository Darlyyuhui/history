...
$(function(){
	...
	type_key = parent.getType_key();

	$.ajax({
		type: "POST",
		url: "../../../../unit_type/getUnit_typeByKey",
		data: {
			"type_key":type_key
		},
		success:function(returnedData){
			var jo0 = eval("("+returnedData+")");
			ctype_name = jo0.type_name;
			comp_key = jo0.comp_key;
			$("#type_name").val(jo0.type_name);
			type_pic = jo0.type_pic;
		 	var help = type_pic.split(";");
