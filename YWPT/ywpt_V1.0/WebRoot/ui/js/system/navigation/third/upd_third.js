...
$(function(){
	t_id = parentIframe.getT_id();
	cs_id = parentIframe.getS_id();
	$.ajax({
		type: "POST",
		url: "../../../../third/getThirdByID",
		data: {
			"t_id":t_id
		},
			...
			$.ajax({
				...
				success:function(returnedData){
					...
					if(jo0.t_name=="add"){
						...
						str1 +="<li data-option='edit'>修改</li>";
						str1 +="<li data-option='query'>查询</li>";
						str1 +="<li data-option='exportexcel'>Excel导出</li>";
					}else if(jo0.t_name=="delete"){
						str1 +="<div class='model-select-text' id='name_select' data-value='delete'>删除</div>"+ 
						"<ul class='model-select-option'>";
						str1 +="<li data-option='add'>添加</li>";
						str1 +="<li data-option='delete' class='seleced'>删除</li>";
						str1 +="<li data-option='edit'>修改</li>";
						str1 +="<li data-option='query'>查询</li>";
						str1 +="<li data-option='exportexcel'>Excel导出</li>";
					}else if(jo0.t_name=="edit"){
						str1 +="<div class='model-select-text' id='name_select' data-value='edit'>修改</div>"+ 
						"<ul class='model-select-option'>";
						str1 +="<li data-option='add'>添加</li>";
						str1 +="<li data-option='delete'>删除</li>";
						str1 +="<li data-option='edit' class='seleced'>修改</li>";
						str1 +="<li data-option='query'>查询</li>";
						str1 +="<li data-option='exportexcel'>Excel导出</li>";
					}else if(jo0.t_name=="query"){
						str1 +="<div class='model-select-text' id='name_select' data-value='query'>查看</div>"+ 
						"<ul class='model-select-option'>";
						str1 +="<li data-option='add'>添加</li>";
						str1 +="<li data-option='delete'>删除</li>";
						str1 +="<li data-option='edit'>修改</li>";
						str1 +="<li data-option='query' class='seleced'>查询</li>";
						str1 +="<li data-option='exportexcel'>Excel导出</li>";
					}else if(jo0.t_name=="exportexcel"){
						str1 +="<div class='model-select-text' id='name_select' data-value='exportexcel'>Excel导出</div>"+ 
						"<ul class='model-select-option'>";
						str1 +="<li data-option='add'>添加</li>";
						str1 +="<li data-option='delete'>删除</li>";
						str1 +="<li data-option='edit'>修改</li>";
			...
			$.ajax({
				...
				success:function(returnedData){
					...
					if(jo0.check =="true"){
						...
						if(s_id==cs_id){
							parentTree.updNode(t_id,t_name);
						}else{
							parentTree.delNode1(t_id,s_id);
							parentTree.updNode(t_id,t_name);
						}
						parentIframe.flush();
