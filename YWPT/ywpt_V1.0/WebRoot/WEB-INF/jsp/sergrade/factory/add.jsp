...
<div class="conten_box" style="overflow:hidden;">
	<form id="inputForm" class="form-inline" action="${root}/sergrade/factory/info/doAdd" method="post" style="margin:0;">
		<h4 class="xtcs_h4" style="margin: 0;">运维服务商--添加</h4>
		...
		<div class="mar_5">
		  <table class="table table-border-rl table-border-bot bukong-table">
			<tr>
				...
				<td>
					<input style="width:160px;" type="text" id="name" name="name" class="required" maxlength="16">
					<font color="red">*</font>
				</td>
				
				<td class="device_td_bg3">联系人：</td>
				<td>
					<input style="width:160px;" type="text" id="linkman" name="linkman" class="required" maxlength="16">
					<font color="red">*</font>
				</td>		
			</tr>
			...
			<tr>
				...
				<td colspan="3">
					<input style="width:160px;" type="text" id="telphone" name="telphone" class="required" maxlength="16">
					<font color="red">*</font>
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="3"><textarea rows="4" maxlength="100" style="width:50%;" class="span8" name="remark"></textarea><span></span></td>
			</tr>
		  </table>
		</div>
		<div class="btn_line">
