...
<div class="row-fluid">
	<c:if test="${pageList.result!='[]'}">
		<tags:paginationnew page="${pageList}" pageaction="${root}/question/top/form/search/${menuid}/" ></tags:paginationnew>
	</c:if>
</div>
...
<form method="post" name="form1" id="form1">
	...
	<input type="hidden" id="flag" name="post_flag"/>
</form>
...
<script>
	...
	function doExport(){
		...
		document.getElementById("flag").value = window.parent.document.getElementById("flag").value;
		
	    document.form1.action="${root}/question/top/export/doExport/${menuid}/?tag="+stateType;
