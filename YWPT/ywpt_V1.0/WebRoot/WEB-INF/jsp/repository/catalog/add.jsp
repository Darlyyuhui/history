...
<div class="conten_box" style="margin-right:0; margin-left:180px;">
	<form id="inputForm" class="form-inline" action="${root}/repository/catalog/doAdd/${type}/${menuid}/" method="post" style="margin-bottom:0; padding-bottom:0;">
		<h4 class="xtcs_h4" style="margin: 0;">新建目录</h4>
		...
		<div class="mar_5">
		  <table class="table table-border-bot table-border-rl tingche-table">
		    <tr>
				<td class="device_td_bg3">上级目录名称：</td>
				<td>
					${pname}
				</td> 
			</tr>
			<tr>
				...
				<td>
					<input style="width:50%;" type="text" id="name" name="name" class="required" minlength="3" maxlength="20">
					<font color="red">*</font>
				</td> 
			</tr>
			<tr>
				<td class="device_td_bg3">备&nbsp;&nbsp;&nbsp;&nbsp;注：</td>
				<td><textarea rows="1" maxlength="100" style="width:50%;" class="span8" name="note"></textarea><span></span></td>
			</tr>
		  </table>
		</div>
		<div class="btn_line">
