...
<div class="conten_box" style="margin-right:0; margin-left:180px;">
	<form id="inputForm" class="form-inline" action="${root}/repository/input/doUpdate" method="post" style="margin:0; padding:0;">
		...
		<div class="mar_5">
		  <table class="table table-border-bot table-border-rl tingche-table" width="100%">
			<tr>
				...
				<td>
					<input style="width:50%;" type="text" name="name" value="${knowledge.name}" class="required" minlength="3" maxlength="30">
					<font color="red">*</font>
				</td> 
			</tr>
			<tr>
				...
				<td>
					<textarea rows="1" maxlength="100" style="width:50%" name="note" >${knowledge.note}</textarea>
				</td>
			</tr>
			<tr>
				<td class="device_td_bg3">文件内容：</td>
				<td>
					<textarea rows="3" maxlength="2000" style="width:660px" id="txt_content" name="context" >${knowledge.context}</textarea>
				</td>
			</tr>
		  </table>
		</div>
