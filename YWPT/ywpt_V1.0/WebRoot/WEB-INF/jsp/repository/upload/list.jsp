...
<div class="conten_box" style="height:730px;overflow:hidden;">
	<h4 class="title_intro">知识库管理-文档上传</h4>
	<div class="table_box">
		...
		<div class="mar_t5">
			<div class="pull-left ztree_box" style="height:650px; width:175px;overflow:auto; position:fixed;left:6px;">
				<ul id="tree-folder" class="ztree" style="min-height:500px;margin-top:5px; width:260px;"></ul> 
			</div>
			<iframe name="myIframe" style="min-height:660px;" frameborder="0" scrolling="no" width="100%" align="right" id="myIframe" src=""></iframe>
			<div class="clear"></div>
		</div>
...
<script type="text/javascript">
	...
	function treeClick(event, treeId, treeNode, clickFlag) {
		...
		if(chooseId == '00'){
			myIframe.window.location.href = "${root}/repository/upload/sublist/${menuid}/";
		}else{
			myIframe.window.location.href = "${root}/repository/upload/sublist/${menuid}/?search_pid=" + chooseId;
		}
	}
	...
	$(document).ready(function(){
		$("#myIframe").attr("src","${root}/repository/upload/sublist/${menuid}/");
	...
	$("#addFolder").click(function(){
		...
		myIframe.window.location.href="${root}/repository/catalog/showAdd/${menuid}/" + nodes[0].id + "/?type=upload";
	...
	$("#updateFolder").click(function(){
		...
		myIframe.window.location.href="${root}/repository/catalog/update/"+nodes[0].id+"/${menuid}/?type=upload";
	});
