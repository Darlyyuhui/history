...
<script type="text/javascript">
    ...
    function exportXls(){
        window.location.href="${root}/system/retrieve/exportXls/?search_startTime=${retrieveInfo.startTime}&search_endTime=${retrieveInfo.endTime}&search_operator=${retrieveInfo.operator}";
    }
	    ...
	    <form class="form-inline" action="${root}/system/retrieve/list/${menuid}/" method="post" style="margin:0;padding:0 6px;">
			<table width="100%">
			  ...
			  <td class="td54">操作人</td>
                ...
                <td><input name="search_startTime" type="text" value="${retrieveInfo.startTime}" class="Wdate" id="beginDate"
                ...
                <td><input name="search_endTime" type="text" value="${retrieveInfo.endTime}" class="Wdate" id="endDate"
          ...
          <div class="btn-group-wrap mar_b5">
			<div class="btn-group pull-right">
			  <btn:authorBtn menuid="${menuid}" text="还原">
				<button class="btn btn-small" onclick="revertData();"><i class="icon-plus"></i>还原</button>
			  </btn:authorBtn>
			...
			<tbody id="tbody">
				<c:forEach items="${pageList.result}" var="retrieveInfo">
					<tr>
						...
						<td>
						  <a style="height:14px; line-height:14px; font-size:12px; color:#fff;" href="javascript.html#"
						  class="btn btn-danger" rel="popover" title="删除内容" data-content='${retrieveInfo.content}'>详细内容</a>
						</td>
...
<!--
	...
	function showList(){
		window.location.href = "${root}/system/retrieve/list/${menuid}/";
    }
//-->
</script>
