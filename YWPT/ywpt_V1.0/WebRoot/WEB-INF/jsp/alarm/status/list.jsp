...
<div class="conten_box" style="height: 695px;overflow:hidden;">
	<h4 class="title_intro">状态监测-信息维护</h4>
	<div class="mar_5">
...
<script type="text/javascript">
	...
	var firstAsyncSuccessFlag =0;
  	$(document).ready(function(){
	    ...
	    myIframe.window.location.href="${root}/alarm/status/search/device/${menuid}/";
 	});
    ...
    function treeOnlick(event, treeId, treeNode, clickFlag){
    	...
    	if(chooseId == '001'){
	   	  	...
	   	  	myIframe.window.location.href="${root}/alarm/status/search/video/${menuid}/";
    	}else if(chooseId == '007'){
	   	  	myIframe.window.location.href="${root}/alarm/status/search/cabinet/${menuid}/";
    	}else {
       		if(chooseId == '003'){
   		   	  	myIframe.window.location.href="${root}/alarm/status/search/database/${menuid}/";
       		}else if(chooseId == '004'){
   		   	  	myIframe.window.location.href="${root}/alarm/status/search/ftp/${menuid}/";
       		}else if(chooseId == '005'){
   		   	  	myIframe.window.location.href="${root}/alarm/status/search/server/${menuid}/";
       		}else if(chooseId == '006'){
   		   	  	myIframe.window.location.href="${root}/alarm/status/search/project/${menuid}/";
       		}
    	}
    }
