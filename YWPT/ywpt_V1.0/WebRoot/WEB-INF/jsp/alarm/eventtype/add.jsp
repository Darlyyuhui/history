...
<div class="conten_box">
	<form id="inputForm" class="form-inline" action="${root}/alarm/eventtype/doAdd" method="post" style="margin:0;">
		<h4 class="xtcs_h4" style="margin:0;">事件类型-添加</h4>
		...
		<div class="mar_5">
		  <table class="table tingche-table table-border-rl table-border-bot" width="100%">
			<tr>
				...
				<td>
					<input style="width:40%;" type="text" id="name" name="name" class="required" maxlength="30">
					<font color="red">*</font>
				</td> 
			</tr>
			<tr>
				...
				<td>
					<input style="width:40%;" type="text" id="code" name="code" class="required" maxlength="10">
					<font color="red">*</font>
				</td> 
			</tr>
			<tr>
			...
			<tr> 
				...
				<td>
				  <select style="width:41%;" id="type" name="type" placeholder="类别" class="required">
					...
					<option value="device">卡口</option>
					<option value="server">服务器</option>
					<option value="database">数据库</option>
					<option value="ftp">FTP</option>
					<option value="project">平台</option>
...
<!--
	function showList(){
		window.location.href = "${root}/alarm/eventtype/list/${menuid}/?isgetsession=1&page=" + <%=pages%>;
	}
