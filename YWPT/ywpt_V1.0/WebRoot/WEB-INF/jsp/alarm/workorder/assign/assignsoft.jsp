		...
		<div class="mar_5">
			<table class="table table-border-rl table-border-bot bukong-table" width="100%">
				<tr>
					...
					<td width="40%">
						<input class="required" readonly autocomplete="off" style="width:60%;" name="devicename" value="${asset.assetname}" type="text" /> 
					</td>
					<td class="device_td_bg3" width="10%">资产编号：</td>
					<td width="40%">
						<input class="required" readonly autocomplete="off" style="width:60%;" name="devicecode" value="${asset.assetcode}" type="text" /> 
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input class="required" readonly autocomplete="off" style="width:60%;" name="position" value='${asset.installplace}' type="text" /> 
					</td>
					<td class="device_td_bg3">设备IP：</td>
					<td>
						<input class="required" readonly autocomplete="off" style="width:60%;" name="deviceip" value="${asset.ip}" type="text" /> 
					</td>
				</tr>
			</table>
		</div>
