...
<div class="conten_box">
	<form id="inputForm" class="form-inline" action="${root}/alarm/workrule/doAdd" method="post" style="margin:0;">
		<h4 class="xtcs_h4" style="margin:0;">评估规则-添加</h4>
		...
		<div class="mar_5">
		  <table class="table tingche-table table-border-rl table-border-bot" width="100%">
			<tr>
				...
				<td>
					<input style="width:40%;" type="text" id="name" name="name" class="required" chinese="true" maxlength="20">
					<font color="red">*</font>
				</td> 
			</tr>
			<tr>
				...
				<td>
				    <input style="width:40%;" type="text" id="code" name="code" englishDigits="true" class="required" maxlength="10">
					<font color="red">*</font>
		        </td>
			</tr>
			<tr>
				...
				<td>
				    <input style="width:40%;" type="text" id="describe" name="describe" class="required" maxlength="100">
					<font color="red">*</font>
		        </td>
			</tr>
			<tr>
				...
				<td>
				    <input style="width:40%;" type="text" id="score" name="score" class="required" maxlength="2" digits="true">
					<font color="red">*</font>
		        </td>
			</tr>
			<tr>
...
<!--
	function showList(){
		window.location.href = "${root}/alarm/workrule/list/${menuid}/?isgetsession=1&page=" + <%=pages%>;
	}
