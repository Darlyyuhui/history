...
<div class="conten_box" style="margin-left: 180px;">
	<form id="inputForm" class="form-inline" action="${root}/property/ftpinfo/doAdd" method="post">
		<h4 class="xtcs_h4" style="margin:0;">FTP信息-添加</h4>
		...
		<div id="common_div">
			<div>
				<table class="table tingche-table table-border-rl table-border-bot" width="100%">
					<tr>
						...
						<td style="width: 36%">
							<input style="width:160px;" type="text" id="ftptype" name="ftptype" maxlength="15" class="required" maxlength="50">
							<font color="red">*</font>
						</td>
					</tr>
					<tr> 
					...
					<tr> 
						...
						<td>
							<input style="width:160px;" type="text" id="username" name="username" class="required" maxlength="10" specialcharfilter="true">
							<font color="red">*</font>
						</td>
						<td class="device_td_bg3">密码：</td>
						<td>
							<input style="width:160px;" type="text" id="password" name="password" password="true" maxlength="12" class="required">
							<font color="red">*</font>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input style="width:160px;" type="text" id="dirname" name="dirname"  maxlength="15" class="required">
			...
			<div style="height: 22px;margin-left: 5px;margin-bottom: 5px;">
				<input type="checkbox" onclick="show(this)"/><font style="font-family: inherit;font-weight: bolder;color: red;font-size: small;">加入监控</font>
			</div>
			<div id="asset_div" style="display: none;">
		  		<table class="table table-border-rl table-border-bot tingche-table" width="100%">
		  		  ...
		  		  <tr>
		  		    ...
		  		    <td>
		  		    	<input style="width:160px;" name="installplace" class="required" maxlength="50" type="text" placeholder="安装地点" value=内场服务器 />
			          	<font color="red">*</font>
			        </td>
		  		  </tr>
		  		  <tr>
...
<script type="text/javascript">
	...
	function showList(){
		window.location.href = "${root}/property/ftpinfo/list/${menuid}/?isgetsession=1&page=" + <%=pages%>;
	}
