...
<div class="conten_box" style="margin-left: 180px;">
	<form id="inputForm" class="form-inline" action="${root}/property/databaseinfo/doUpdate?assetid=${asset.id}&isasset=${isasset}" method="post">
		<h4 class="xtcs_h4" style="margin:0;">数据库信息-修改</h4>
			...
			<div>
				<table class="table tingche-table table-border-rl table-border-bot" width="100%">
					<tr>
						...
						<td style="width: 38%">
							<input style="width:160px;" type="text" id="name" name="name" value="${database.name}" maxlength="30" class="required" maxlength="50">
							<font color="red">*</font>
						</td> 
						<td class="device_td_bg3" style="width: 12%">数据库类型：</td>
						<td style="width: 38%">
							<input style="width:160px;" type="text" id="dialect" name="dialect" value="${database.dialect}" maxlength="15" class="required" maxlength="50">
							<font color="red">*</font>
						</td>
					</tr>
					<tr> 
						...
						<td>
							<input style="width:160px;" type="text" id="ip" name="ip" value="${database.ip}" ip="true" maxlength="15" class="required">
		                    <font color="red">*</font>
						</td>
						<td class="device_td_bg3">端口号：</td>
						<td>
							<input style="width:160px;" type="text" id="port" name="port" value="${database.port}" class="required" minlength="2" maxlength="5" digits="true">
							<font color="red">*</font>
						</td>
					</tr>
					<tr> 
						...
						<td>
							<input style="width:160px;" type="text" id="username" name="username" value="${database.username}" class="required" maxlength="10" specialcharfilter="true">
							<font color="red">*</font>
						</td>
						<td class="device_td_bg3">密码：</td>
						<td>
							<input style="width:160px;" type="text" id="password" name="password" value="${database.password}" password="true" maxlength="12" class="required">
							<font color="red">*</font>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input style="width:160px;" type="text" id="sid" name="sid" value="${database.sid}" maxlength="15" class="required">
				          ...
				          <select style="width:170px;padding:4px;overflow:hidden;" id="factoryId" name="factoryId" class="required">
				            ...
				            <c:forEach items="${factoryList}" var="factory">
				              <option value="${factory.id}" ${factory.id==database.factoryId?'selected':''}>${factory.name}</option>
				            </c:forEach>
					      </select>
					      <font color="red">*</font>
				        </td>
			...
			<div id="asset_div" style="display: none;">
		  		<table class="table table-border-rl table-border-bot tingche-table" width="100%">
		  		  ...
		  		  <tr>
		  		    ...
		  		    <td>
		  		    	<input style="width:160px;" name="manufacturer" value="${asset.manufacturer}" class="required" maxlength="30" type="text" placeholder="生产厂商" />
			          	<font color="red">*</font>
			        </td>
		  		  </tr>
		  		  <tr>
		  		    ...
		  		    <td>
		  		    	<input style="width:160px;" name="engineering" value="${asset.engineering}" class="required" maxlength="30" type="text" placeholder="工&nbsp;&nbsp;程&nbsp;&nbsp;商" />
			          	<font color="red">*</font>
			        </td>
		  		  </tr>
		  		  <tr>
...
<script type="text/javascript">
	...
	function showList(){
		window.location.href = "${root}/property/databaseinfo/list/${menuid}/?isgetsession=1&page=${page}";
	}
	function checkForm(){
		return true;
	}
	$(document).ready(function() {
		...
		$("#inputForm").validate({
			rules: {
				"name":{
					remote:{
						url:"${root}/property/databaseinfo/nameExist",
						type:"post",
						data:{
							name:function(){
								return $("#name").val();
