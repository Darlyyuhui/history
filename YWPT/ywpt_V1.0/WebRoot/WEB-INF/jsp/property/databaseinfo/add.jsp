...
<div class="conten_box" style="margin-left: 180px;">
	<form id="inputForm" class="form-inline" action="${root}/property/databaseinfo/doAdd" method="post">
		<h4 class="xtcs_h4" style="margin:0;">数据库信息-添加</h4>
			...
			<div>
				<table class="table tingche-table table-border-rl table-border-bot" width="100%">
					<tr>
						...
						<td style="width: 38%">
							<input style="width:160px;" type="text" id="dialect" name="dialect" maxlength="15" class="required" maxlength="50">
							<font color="red">*</font>
						</td>
					</tr>
					<tr> 
					...
					<tr>
						...
						<td>
							<input style="width:160px;" type="text" id="sid" name="sid"  maxlength="15" class="required">
...
<script type="text/javascript">
	...
	function showList(){
		window.location.href = "${root}/property/databaseinfo/list/${menuid}/?isgetsession=1&page=" + <%=pages%>;
	}
