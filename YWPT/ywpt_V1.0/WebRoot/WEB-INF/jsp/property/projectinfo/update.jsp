...
<div class="conten_box" style="margin-left: 180px;">
	<form id="inputForm" class="form-inline" action="${root}/property/projectinfo/doUpdate?assetid=${asset.id}&isasset=${isasset}" method="post">
		<h4 class="xtcs_h4" style="margin:0;">平台信息-修改</h4>
			...
			<div>
				<table class="table tingche-table table-border-rl table-border-bot" width="100%">
					<tr>
						...
						<td colspan="3">
							<input style="width:160px;" type="text" id="name" name="name" value="${project.name}" maxlength="30" class="required" maxlength="50">
							<font color="red">*</font>
						</td> 
					</tr>
					<tr> 
						...
						<td style="width: 38%">
							<input style="width:160px;" type="text" id="ip" name="ip" value="${project.ip}" ip="true" maxlength="15" class="required">
		                    <font color="red">*</font>
						</td>
						<td class="device_td_bg3" style="width: 12%">端口号：</td>
						<td style="width: 38%">
							<input style="width:160px;" type="text" id="port" name="port" value="${project.port}" class="required" minlength="2" maxlength="5" digits="true">
							<font color="red">*</font>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input style="width:160px;" type="text" id="url" name="url" value="${project.url}" maxlength="15" class="required">
				          ...
				          <select style="width:170px;padding:4px;overflow:hidden;" id="factoryId" name="factoryId" class="required">
				            ...
				            <c:forEach items="${factoryList}" var="factory">
				              <option value="${factory.id}" ${factory.id==project.factoryId?'selected':''}>${factory.name}</option>
				            </c:forEach>
					      </select>
					      <font color="red">*</font>
				        </td>
...
<script type="text/javascript">
	...
	function showList(){
		window.location.href = "${root}/property/projectinfo/list/${menuid}/?isgetsession=1&page=${page}";
	}
	function checkForm(){
		return true;
	}
