...
<div class="conten_box">
	<form id="inputForm" class="form-inline" action="${root}/property/deviceftp/doUpdate" method="post" style="margin:0;">
		<h4 class="xtcs_h4" style="margin: 0;">文件服务器 -修改</h4>
		...
		<div class="mar_5">
		  <table class="table tingche-table table-border-rl table-border-bot">
			...
			<tr>
				...
				<td>
					<input style="width:160px;" type="text" id="ftpport" name="ftpport" value="${ftpInfo.ftpport}" class="required" minlength="2" maxlength="5" digits="true">
					<font color="red">*</font>（FTP上传使用）
				</td> 
				<td class="device_td_bg3">下行端口：</td>
				<td>
					<input style="width:160px;" type="text" id="httpport" name="httpport" value="${ftpInfo.httpport}" minlength="2" maxlength="5" digits="true">
                    （HTTP下载使用）
				</td>			
			</tr>
			<tr>
				...
				<td>
					<input style="width:160px;" type="text" id="dirname" name="dirname" value="${ftpInfo.dirname}" maxlength="10" class="required">
                    <font style="color: red;"> *</font>
				</td>			
			</tr>
			<tr>
