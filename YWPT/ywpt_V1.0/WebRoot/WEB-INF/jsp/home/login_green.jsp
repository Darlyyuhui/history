...
<link href="${root}/css/login_green.css" rel="stylesheet" type="text/css"/>
<body class="body_bg">
<div class="wrap">
  <div class="login_box">
    <div class="sys_name">${itmsname}</div>
    <div class="login_main">
      <p><img src="${root}/images/pictwo/login_bt.gif"></p>
      <div class="main_box">
        <div class="itms_logo"><img src="${root}/images/pictwo/itms_logo.png"></div>
