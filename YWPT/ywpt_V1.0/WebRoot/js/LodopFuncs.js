...
**************************/
        var strHtmInstall="<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='"+root+"/downloadfile/Print.zip/?filepath=sysfile/PrintPlugins.zip'>下载</a>,解压安装后请刷新页面或重新进入。</font>";
        var strHtmUpdate="<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='"+root+"/downloadfile/Print.zip/?filepath=sysfile/PrintPlugins.zip'>下载</a>,解压升级后请重新进入。</font>";
        var strHtm64_Install="<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='"+root+"/downloadfile/Print.zip/?filepath=sysfile/PrintPlugins.zip'>下载</a>,解压安装后请刷新页面或重新进入。</font>";
        var strHtm64_Update="<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='"+root+"/downloadfile/Print.zip/?filepath=sysfile/PrintPlugins.zip'>下载</a>,解压升级后请重新进入。</font>";
